    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="a_description" id="" cols="30" rows="3" placeholder="Mô tả">{{old('a_description', isset($article->a_description) ? $article->a_description : '')}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="a_content" id="a_content" cols="30" rows="3" placeholder="Nội dung">{{old('a_content', isset($article->a_content) ? $article->a_content : '')}}</textarea>
