...
@section('content')
    ...
    <div class="table-responsive">
        ...
        <table class="table table-striped">
            ...
            <tr>
                <td>{{$product->id}}</td>
                <td><a href="{{route('get.detail.product',[$product->pro_slug,$product->id])}}" target="_blank">{{$product->pro_name}}</a>
                    <ul style="padding-left: 15px">
                        <li><span><i class="fad fa-usd-circle"></i><span></span>{{number_format($product->pro_price,0,',','.')}} đ</span></li>
                        <li><span><i class="fad fa-usd-circle"></i><span></span>{{$product->pro_sale}} %</span></li>
                        <li>
                            <span>Đánh giá : </span>
                            <span class="rating">
                                @for($i = 1 ; $i <=5 ; $i ++)
                ...
                <td><a href="{{ pare_url_file($product->pro_avatar)}}" target="_blank">
                ...
                <td>
                    <a style="padding: 5px 10px;border: 1px solid #999;font-size: 12px" href="{{route('admin.get.edit.product',$product->id)}}"><i class="fas fa-pen" style="font-size: 11px;margin-right: 3px"></i>Cập nhật</a>
                    <a style="padding: 5px 10px;border: 1px solid #999;font-size: 12px" href="{{route('admin.get.action.product',['delete',$product->id])}}"><i class="fas fa-trash" style="font-size: 11px;margin-right: 3px"></i>Xóa</a>
                </td>
            </tr>
            @endforeach
            @endif
